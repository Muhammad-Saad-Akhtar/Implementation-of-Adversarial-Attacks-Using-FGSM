...
class FGSMAttackRequest(BaseModel):
    ...
    attack_type: str = Field(default="untargeted", description="Attack type: 'untargeted' or 'targeted'", regex="^(untargeted|targeted)$")
...
class BatchFGSMRequest(BaseModel):
    ...
    attack_type: str = Field(default="untargeted", description="Attack type", regex="^(untargeted|targeted)$")
...
async def file_attack_endpoint(
    ...
    attack_type: str = Form("untargeted", description="Attack type (untargeted/targeted)", regex="^(untargeted|targeted)$"),
